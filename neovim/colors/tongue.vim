...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#6e6d68 guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi Comment gui=NONE guifg=#504e50 guibg=NONE
    ...
    hi CursorLine gui=NONE guifg=NONE guibg=#3b3735
    hi CursorLineNr gui=NONE guifg=#fe811b guibg=#3b3835
    hi DiffAdd gui=NONE guifg=NONE guibg=#787208
    hi DiffChange gui=NONE guifg=NONE guibg=#1a1a1a
    hi DiffDelete gui=NONE guifg=NONE guibg=#9e0005
    ...
    hi Normal gui=NONE guifg=#b0b0b0 guibg=#32302f
    ...
    hi Statement gui=bold guifg=#8f8f8f guibg=NONE
    hi StatusLine gui=NONE guifg=#9e9e9e guibg=#262626
    hi StatusLineNC gui=NONE guifg=#707070 guibg=#262626
    hi StorageClass gui=bold guifg=#8f8f8f guibg=NONE
    hi String gui=NONE guifg=#626062 guibg=NONE
